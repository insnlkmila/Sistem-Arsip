...
<head>
    ...
    <title>Admin - Edit Arsip Akte Kelahiran</title>
      ...
      <div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <div class="col-lg-10">
                    <h2>Edit Arsip Akte Kelahiran</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="index.php">Home</a>
                        </li>
                          <li>
                            <a href="arsip.php">Data Arsip Akte Kelahiran</a>
                        </li>
                        <li class="active">
            ...
            <div class="col-lg-5">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Form Edit Arsip Akte Kelahiran</h5>
                        ...
                        <?php
$id_arsip=mysql_real_escape_string($_GET['id_arsip']);
$det=mysql_query("select * from arsip_akte where id_arsip='$id_arsip'")or die(mysql_error());
while($d=mysql_fetch_array($det)){
?>
                        <div class="ibox-content">
                            <form action="edit_act.php" method="post" class="form-horizontal">
                                    <input type="hidden" name="id_arsip" id="id_arsip" placeholder="Nama" value="<?php echo $d['id_arsip'] ?>"class="form-control"> 
                            <div class="form-group"><label  control-label">Nama</label>

                                    <div ><input type="text" name="nama" id="nama" placeholder="Nama" value="<?php echo $d['nama'] ?>"class="form-control"> 
                                    </div>
                                </div>
                               <div class="form-group"><label  control-label">Kota Lahir</label>

                                    <div ><input type="text" name="kota" id="kota" placeholder="Kota lahir" value="<?php echo $d['kota'] ?>" class="form-control"></div>
                                </div>
                                <div class="form-group"><label  control-label">Tanggal Lahir</label>

                                    <div ><input type="date" name="tgl_lahir" id="tgl_lahir" placeholder="Tanggal Lahir" value="<?php echo $d['tgl_lahir'] ?>" class="form-control"></div>
                                </div>
                                <div class="form-group"><label  control-label">Alamat</label>
                                    <div ><input type="text" name="alamat" id="alamat" placeholder="Alamat" value="<?php echo $d['alamat'] ?>"class="form-control"></div>
                                </div>
                                 ...
                                 <div class="form-group"><label control-label">Keterangan</label>
                                    ...
                                    <div ><input type="text"  name="keterangan" id="keterangan" placeholder="Keterangan" value="<?php echo $d['keterangan'] ?>"class="form-control"> 
                                    </div>
                                </div>
