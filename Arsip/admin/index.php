...
<head>
    ...
    <!-- Toastr style -->
    <link href="../tampilan/css/plugins/toastr/toastr.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="../tampilan/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
				 ...
				 <div class="col-lg-3">
						...
						<?php $arsip_akte = mysql_num_rows(mysql_query("SELECT * FROM arsip_akte")); ?>
                            <div class="ibox-title">
                                <h4>Arsip Akte Kelahiran</h4>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"><a href="surat_masuk.php"> <i class="fa fa-mail-forward"></i><?php echo $arsip_akte; ?></a></h1>
                       ...
                       <center><h2> (Sistem Informasi Pengarsipan Akte Kelahiran)</h2>
                       Dinas DUKCAPIL</h1></br>
                       <img alt="image" src="../tampilan/img/logo1.png"  width="350" height="250" />
                       </center>
    ...
    <script>
        $(document).ready(function() {
            setTimeout(function() {
                ...
                toastr.success('Sistem Informasi Pengarsipan Surat', 'Selamat Datang di');
