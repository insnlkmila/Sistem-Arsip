...
<head>
    ...
    <title>Admin- Arsip Akte Kelahiran</title>
...
<body>
      <div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <div class="col-lg-10">
                    <h2>Data Arsip Akte Kelahiran</h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong>Data Arsip Akte Kelahiran</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
			...
			<a href="tambaharsip.php"><button class="btn btn-success" type="button"><i class="fa fa-plus"></i> Input Akte Kelahiran</button></a></button>
	...
	if(isset($_GET['cari'])){
		...
		$arsip_akte=mysql_query("select * from arsip_akte '$cari'");
	}else{
		$arsip_akte=mysql_query("select * from arsip_akte limit $start, $per_hal");
	}
	$no=1;
	while($b=mysql_fetch_array($arsip_akte)){

		?>
		<tr>
			<td><?php echo $no++ ?></td>
			<td><?php echo $b['nama'] ?></td>
			<td><?php echo $b['kota'].",".$b['tgl_lahir'] ?></td>
			<td><?php echo $b['alamat'] ?></td>
			<td><?php echo $b['tgl_input'] ?></td>
           <td><?php echo $b['keterangan'] ?></td>
			<td><center>
				
				<a href="edit.php?id_arsip=<?php echo $b['id_arsip']; ?>"><i class="fa fa-pencil"></i></a> 
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data dengan Nama : <?php echo $b['nama'];?>  ??')){ location.href='hapus.php?id_arsip=<?php echo $b['id_arsip']; ?>' }"><i class="fa fa-trash"></i></a>
                </center>
			</td>
